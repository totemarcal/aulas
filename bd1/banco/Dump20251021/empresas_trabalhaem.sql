...
CREATE TABLE `trabalhaem` (
  ...
  KEY `codproj` (`codproj`),
  CONSTRAINT `trabalhaem_ibfk_1` FOREIGN KEY (`Mat`) REFERENCES `empregado` (`Matricula`),
  CONSTRAINT `trabalhaem_ibfk_2` FOREIGN KEY (`codproj`) REFERENCES `projeto` (`Cod`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `trabalhaem`
--

LOCK TABLES `trabalhaem` WRITE;
